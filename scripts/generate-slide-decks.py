    ...
    Deck(
        ...
        slides=[
            Slide(
                kind="title",
                eyebrow="Lesson 2",
                headline="Rewriting and Editing",
            ...
            Slide(
                ...
                body=[
                    ...
                    "Compare the rewrite to the original side by side.",
                    "Anything new = suspect. Verify or remove.",
                ],
            ),
        ],
    ),
    ...
    Deck(
        ...
        slides=[
            Slide(
                kind="title",
                eyebrow="Lesson 1",
                headline="AI-Powered Formulas",
                subhead="Stop Googling. Start describing.",
            ),
            Slide(
                kind="concept",
                eyebrow="What you're learning",
                headline="Conditional logic, in plain English",
                body=[
                    "Describe the rule — \"OVER BUDGET if Spent > Budget.\"",
                    "AI writes the formula (IF / IFS / SWITCH).",
                    "Watch for absolute vs relative references ($B$2 vs B2).",
                ],
            ),
            Slide(
                kind="callout",
                ...
                callout="Plug in numbers where you already know the answer.\nIf the formula gives the wrong result — find out now.",
            ),
        ],
    ),
    Deck(
