...
const badgeIcons: Record<string, React.ReactNode> = {
  ...
  'prompt-pro': <Brain className="w-6 h-6" />,
  'security-shield': <Shield className="w-6 h-6" />,
  'agent-handler': <Bot className="w-6 h-6" />,
  'data-wrangler': <Database className="w-6 h-6" />,
  'power-user': <Star className="w-6 h-6" />,
...
const badgeColors: Record<string, string> = {
  ...
  'prompt-pro': 'from-purple-400 to-purple-600',
  'security-shield': 'from-green-400 to-green-600',
  'agent-handler': 'from-cyan-400 to-cyan-600',
  'data-wrangler': 'from-orange-400 to-red-500',
  'power-user': 'from-indigo-400 to-indigo-600',
  'perfect-score': 'from-pink-400 to-pink-600',
